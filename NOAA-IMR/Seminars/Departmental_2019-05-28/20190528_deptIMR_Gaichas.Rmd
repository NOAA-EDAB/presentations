...
* Focus on climate impacts to growth and mortality (productivity)
* Full factorial design over assumptions about growth and mortality used in operational stock assessments

    * Growth:
      1. constant growth parameters
      1. regime shifts in growth parameters (Stawitz et al. 2019)
      1. empirical weight-at-age (Kuriyama et al. 2016)
    ...
    * Also, an equally weighted ensemble of the 9 estimating models
