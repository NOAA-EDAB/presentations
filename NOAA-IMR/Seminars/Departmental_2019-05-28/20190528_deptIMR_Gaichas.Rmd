...
* Range of assumptions about growth and mortality currently used in operational stock assessments

* Stock synthesis framework initially, due to familiarity 

* Can extend to other assessment models, generalize, and use components of the REDUS framework?
