...
Diverse stakeholders agreed that an ecosystem approach was necessary. Rapid progress in implementing an ecosystem approach to fishery management resulted from collaboration between managers, stakeholders, and scientists. 
...
And many people answered, from commercial fishery, recreational fishery, environmental NGO, and interested public perspectives.
...
---
## How was the Ecosystem approach developed?

Visioning Project &rarr; Strategic Plan with one objective to develop 
>"A non-regulatory umbrella document intended to guide Council policy with respect to ecosystem considerations across existing FMPs"
...
Iterative process starting with 2015 workshops
...
---
## The Council first defined a range of risk elements: Ecological
...
---
background-image: url("EDAB_images/nes-components.png")
...
## Meanwhile, IEA scientists improving ecosystem reports:
...
---
## Example risk indicator: Climate 

This element is applied at the species level. Risks to species productivity (and therefore to achieving OY) due to projected climate change in the Northeast US were evaluated in a comprehensive assessment<sup>1</sup>.
...
---
## Example risk indicator: Commercial revenue 
...
---
## Example risk indicator: ecosystem productivity
...
Four indicators are used together to assess risk of changing ecosystem productivity. 
