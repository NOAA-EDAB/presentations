...
![:img New England EBFM proposed harvest control rules, 75%](EDAB_images/EBFM HCR.png)

![:img Example scenario results using the multispecies simulation model Hydra](EDAB_images/xradarScenario41-50yrs.png)
]
.pull-right[
*Current Draft example Fishery Ecosystem Plan*

[eFEP](https://s3.amazonaws.com/nefmc.org/3_Draft-example-Fishery-Ecosystem-Plan-eFEP_190830_113712.pdf) 
...
* [Atlantic States February 2020 Menhaden Summary](http://www.asmfc.org/uploads/file/5e5e84fbAtlanticMenhadenAssessmentsOverview_Feb2020.pdf)
...
---
## Web-based conceptual model presentation
