...
SOEtime <- data.frame(
  id = 1:28,
  content = c("2019 SOE MAFMC", "2019 SOE NEFMC", "2019 debrief", "SOE workshop",
              "subgroups", "subgroups", "graphics development",  "subgroups", 
              "data submission", "ecodata/visualization", "initial synthesis",
              "strawman", "synthesis workshop", "SOE google doc", "SOE rmarkdown",
              "SOE internal review", "response memo", "MAFMC risk assessment",
              "submit Mid SSC", "2020 SOE Mid SSC", "submit NE SSC", "final editing Mid",
              "submit MAFMC", "2020 NE SSC", "final editing NE", "submit NEFMC", 
              "2020 SOE MAFMC","2020 SOE NEFMC"),
