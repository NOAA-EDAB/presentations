...
subtitle: "Mid-Atlantic and New England 2020<br />Update for ICES WGNARS"
...
SOEtime <- data.frame(
  id = 1:28,
  content = c("present 2019 SOE", "present 2019 SOE", "2019 debrief", "SOE workshop",
              "subgroups", "subgroups", "graphics development",  "subgroups", 
              "data submission", "ecodata/visualization", "initial synthesis",
              "strawman", "synthesis workshop", "google doc", "rmarkdown",
              "internal review", "response memo", "risk assessment",
              "submit SSC", "2020 SOE SSC", "submit SSC", "final editing",
              "submit Council", "2020 SSC", "final editing", "submit Council", 
              "present 2020 SOE","present 2020 SOE"),
  start = c("2019-04-10", "2019-04-17", "2019-04-26", "2019-08-20",
            "2019-09-26", "2019-10-24", "2019-10-31", "2019-11-21",
            "2019-12-13", "2019-12-13", "2019-12-18",
            "2020-01-21", "2020-01-22", "2020-01-27", "2020-02-07",
            "2020-02-14", "2020-02-24", "2020-02-26", 
            "2020-03-03", "2020-03-10", "2020-03-11", "2020-03-12",
            "2020-03-24", "2020-03-31", "2020-03-31", "2020-04-02",
            "2020-04-07", "2020-04-14"),
  end = c(NA, NA, NA, "2019-08-21",
          NA, NA,"2020-03-02", NA,
          "2020-01-22", "2020-01-22", NA, 
          NA, "2020-01-24", "2020-02-06", "2020-02-13",
          "2020-03-03", "2020-03-03", "2020-02-28",
          NA, NA, NA, "2020-03-24",
          NA, NA,"2020-04-02", NA,
          NA, NA),
  type = c("point","point","point","box",
           "point","point","range", "point",
           "box", "box","point",
           "point", "box", "box", "box",
           "range", "box", "box",
           "point","point","point","box",
           "point","point","box","point",
           "point","point"),
  group = c("Mid-Atlantic", "New England", rep("Both", 15),
            rep("Mid-Atlantic",3), "New England",
            rep("Mid-Atlantic",2), rep("New England",3),
            "Mid-Atlantic", "New England")
)

SOEgroup <- data.frame(
  id = c("Mid-Atlantic", "New England", "Both"),
  content = c("Mid-Atlantic", "New England", "Both")
)

fulltl <- timevis(SOEtime, SOEgroup)
#fulltl
...
* [NOAA SOE feature story, 7 April 2020](https://www.fisheries.noaa.gov/feature-story/new-state-ecosystem-reports-document-big-picture-around-fishing)
