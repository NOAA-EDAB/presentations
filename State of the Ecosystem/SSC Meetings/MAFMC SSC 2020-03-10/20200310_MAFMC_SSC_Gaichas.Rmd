...
```{r wind-hab, eval = T, echo = F, fig.height = 4, fig.cap="Map of BOEM existing (black) and proposed (red) lease areas in North (N), Mid (M) and South (S) portions of the coast as of February 2019.", message=FALSE, results=FALSE}
...
Project initiated; discuss how this will be used in risk assessment to refine further
