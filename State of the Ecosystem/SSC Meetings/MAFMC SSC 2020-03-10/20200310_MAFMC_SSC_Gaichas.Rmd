...
![img: US East Coast with ph](EDAB_images/occ_graphic3.jpg)

Until this is available for a time series indicator, we seek feedback on what available information (for example, initial monitoringsup>2</sup>) would be useful to the Councils right now.
