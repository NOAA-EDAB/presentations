...
.pull-left[
Indicators: ocean currents, bottom temperature, marine heatwaves
```{r, code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/LTL_MAB.Rmd-gsi.R"), fig.width=4.5}
```


```{r, code =readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/LTL_MAB.Rmd-bottom-temp.R"), fig.width=4.5}
...
.pull-right[
Indicators: 2020 surface temperature, marine heatwaves 
```{r , code=readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/LTL_MAB.Rmd-seasonal-sst-anom-gridded.R"), fig.asp = 1}
#seasonal-sst-anom-gridded, fig.cap="MAB seasonal sea surface temperature (SST) time series overlaid onto 2020 seasonal spatial anomalies." , fig.width = 8,
```
...
knitr::include_graphics("EDAB_images/ches-temp-temp.png")
...
Indicators: primary production, zooplankton, forage fish (Memo 17), fish condition (Memo 18)


---
## Risks: Ecosystem structure

Indicators: distribution shifts, diversity, predators (Memo 12, 15, 25)
...
---
## Risks: Other ocean uses (Wind): area covered, fisheries impacted
.pull-left[
...
---
## Future: Stabilize this structure, prioritize research

Annual benchmark... hold pattern for a few years?
