...
.pull-right[
Key to figures
```{r , code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/macrofauna_MAB.Rmd-species-dist.R"), fig.asp=.8}
...
.pull-right[
* Risks to meeting fishery management objectives (Memo 4,6)
    - *What* does the indicator say--up, down, stable?
...
-  Acidification levels in surfclam summer habitat are approaching, but not yet at, levels affecting surfclam growth
...
---
## Objective: Stability  (Memo 11)
.pull-right[
*Ecological*
Indicators: zooplankton, larval fish, and adult fish diversity
