...
.contrib[
Key: 
<p style="background-color:#FFA500;">Orange background = Tipping point overfishing threshold;</p> 
<p style="background-color:#00FF00;">Green background= Optimal range</p>
]
...
```{r, code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/human_dimensions_MAB.Rmd-comdat-commercial-landings.R"), fig.width=5, fig.asp=1.4}
...
.pull-right[
* Commercial landings decline most likely driven by **market dynamics affecting the landings of surfclams and ocean quahogs**  

* Recreational seafood landings decline from other drivers, including shark fishery management and possibly survey methodology 
