...
```{r, code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/human_dimensions_MAB.Rmd-comdat-commercial-landings.R"), fig.asp=1.4}
...
.pull-right[
The decline in recreational seafood landings stems from other drivers, including shark fishery management and possibly survey methodology. 
```{r , code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/human_dimensions_MAB.Rmd-rec_hms.R"), fig.width=5, fig.asp=.35}
#rec_hms, fig.cap="Recreational shark landings from Large Pelagics Survey."
