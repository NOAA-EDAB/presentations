...
.pull-left[
.center[
![:img State of the Ecosystem page 1 summary table, 90%](EDAB_images/SOE-MA-final-02.11.22-KH 2.png)
]
]

.pull-right[
.center[
![:img State of the Ecosystem page 2 risk bullets, 90%](EDAB_images/SOE-MA-final-02.11.22-KH 3.png)
]
]
...
---
## Landings drivers: Ecosystem or stock production? TAC? &emsp; Risk elements: Fstatus, Bstatus  unchanged

.pull-left[
New Indicator: Realized catch relative to management target (ABC or ACL)
...
---
## Objective: Commercial fishing community status, environmental justice &emsp; Risk element: <span style="background-color:yellow;">Social</span>, unchanged; new community level info 
...
---
## Objective: Recreational fishing community status, environmental justice  &emsp; Risk element: <span style="background-color:yellow;">Social</span>, unchanged; new community level info 
Indicators: Social vulnerability, fishery engagement and reliance  
.pull-left[
