...
subtitle: "MAFMC SSC<br /> 7 March 2023"
...
.pull-left[
.center[
![:img State of the Ecosystem page 1 summary table, 95%](https://github.com/NOAA-EDAB/presentations/raw/master/docs/EDAB_images/SOE-MA-draft-02.28.23_Page_2.png)
]
]

.pull-right[
.center[
![:img State of the Ecosystem page 2 risk bullets, 95%](https://github.com/NOAA-EDAB/presentations/raw/master/docs/EDAB_images/SOE-MA-draft-02.28.23_Page_3.png)
]
]
...
---
background-image: url("https://github.com/NOAA-EDAB/presentations/raw/master/docs/EDAB_images/SOE-MA-draft-02.28.23_Page_2.png")
...
---
background-image: url("https://github.com/NOAA-EDAB/presentations/raw/master/docs/EDAB_images/SOE-MA-draft-02.28.23_Page_3.png")
background-size: 500px
background-position: right
...
.pull-left[
Indicator: Commercial landings, total and seafood 
...
Implications: There was an increase in recreational fishing activities in the many of the top recreational communities from 2019 to 2020. Highlighted communities may be vulnerable to changes in fishing. When also experiencing environmental justice issues, they may have lower ability to successfully respond to change.
...
.contrib[
The Gulf Stream is further north. Ocean summer is lasting longer. In contrast to SST, long term bottom temperature is increasing in winter as well as other seasons. 
]
...
Summer aragonite saturation was at or below the sensitivity levels for both Atlantic sea scallop and longfin squid in Long Island Sound and the nearshore and mid-shelf regions of the New Jersey shelf several times over the past decade.
...
```{r , code=readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/macrofauna_MAB.Rmd-energy-density.R"), out.width='98%',  fig.asp = 0.5}
...
+ Fewer warm core rings near the shelf plus economic drivers led to lower *Illex* catch in 2022.
]
]
...
---
## EAFM Risk Assessment: 2023 Update (but all methods to be reveiwed/revised this year)
...
---
## Prioritized SOE requests and summarized approaches for using ecosystem information


## Reviewed progress on four projects, February 2023
