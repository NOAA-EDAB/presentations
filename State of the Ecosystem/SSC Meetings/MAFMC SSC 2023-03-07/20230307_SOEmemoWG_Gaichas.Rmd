...
subtitle: "Risk Assessment Update, Request Tracking, and Ecosystem Working Group Report<br />MAFMC SSC<br /> 7 March 2023"
...
.pull-right[
.contrib[ 
* Declining managed benthos: surfclam/ocean quahog markets 
* Declining aggregate planktivores: menhaden fishery consolidation
```{r hack}
...
The Gulf Stream is further north. Ocean summer is lasting longer. In contrast to SST, long term bottom temperature is increasing in all seasons. 
.contrib[]
???
...
```{r , code=readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/macrofauna_MAB.Rmd-energy-density.R"), out.width='95%',  fig.asp = 0.5}
