...
.pull-left[
No effect on NE rec. catch diversity trend
...
.pull-left[
```{r GOM-recruitment, fig.width = 8, fig.height = 5}
...
## SOE Take Home Messages  
  ...
  * Primary production required to support commerical fisheries has declined since 2000
--

  * Commerical fishing engagement has increased in some communities, and New England commercial fisheries catch and revenue remain dependent on single species (lobster and scallops)
--

  * Commercial catch and revenue increased in 2019 (due to lobster and scallops) 
--
  
  * Habitat models identified species most likely to ocurr in wind lease areas; habitat has improved in wind lease areas for NEFMC species except for Atlantic herring
--
