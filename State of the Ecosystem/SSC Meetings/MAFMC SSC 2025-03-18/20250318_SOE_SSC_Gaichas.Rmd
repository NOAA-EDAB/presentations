...
ecodata::plot_commercial_div(report = "MidAtlantic", varName = "Fleet count", n=10)
```
.contrib[
...
ecodata::plot_commercial_div(report = "MidAtlantic", varName = "Permit revenue species diversity", n=10)
```
.contrib[
...
ecodata::plot_ichthyo_diversity(report = "MidAtlantic", n=10)
```
