...
subtitle: "NEFMC SSC Update<br /> 9 April 2025"
author: "Joseph Caracappa, (lead editor)"
output:
...
t1  = 1970:2014
t2 = 2015:2024
val1 =  (11.364*t1)-21387+rnorm(length(t1),0,40)
val2 =  (-10*t2)+21640+rnorm(length(t2),0,10)

dat1 = data.frame(x = c(t1,t2),y = c(val1,val2))
p1 = ggplot(data = dat1, aes(x=x, y= y))+
  geom_line()+
  geom_gls()+
  geom_lm(n = 10)+
  ylab('Value')+
...
val3 =  (-11.364*t1)+23887+rnorm(length(t1),0,40)
val4 =  (20*t2)-39280+rnorm(length(t2),0,10)
dat2 = data.frame(x = c(t1,t2),y = c(val3,val4))

p4 = ggplot(data = dat2, aes(x=x, y= y))+
  geom_line()+
  geom_gls()+
  geom_lm(n = 10)+
  ylab('Value')+
...
*  Current revenue in proposed areas
    - 0-32% by New England port
    - 1-20% by NEFMC managed species
...
<font size="5">
Proposal 1. A combination of Gross Revenue from all trips in New England regions and Net Revenue estimates for federally-permitted vessels.
