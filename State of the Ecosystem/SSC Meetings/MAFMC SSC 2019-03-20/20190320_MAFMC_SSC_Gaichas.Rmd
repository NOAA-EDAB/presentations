...
output:
  xaringan::moon_reader:
    css: ["default", "libs/20190320_MAFMC_SSC_Gaichas_theme.css"]
    lib_dir: libs
    nature:
...
![iea-loop](20190320_MAFMC_SSC_Gaichas_images/iea-loop.png)
...
knitr::include_graphics("20190320_MAFMC_SSC_Gaichas_images/nes-components-abstracted.png")
```
...
knitr::include_graphics("20190320_MAFMC_SSC_Gaichas_images/Framework.png")
```
...
knitr::include_graphics("20190320_MAFMC_SSC_Gaichas_images/SOE_Map.jpg")
```
...
```{r nes-comp1, echo = F}
knitr::include_graphics("20190320_MAFMC_SSC_Gaichas_images/nes-components.png")
```
...
knitr::include_graphics("20190320_MAFMC_SSC_Gaichas_images/sst-anom.png")
```
...
knitr::include_graphics("20190320_MAFMC_SSC_Gaichas_images/MAFMC_Fish_Condition_2019.jpg")
```
...
knitr::include_graphics("20190320_MAFMC_SSC_Gaichas_images/sptable2019.png")
```
*Ecosystem level risk elements*
```{r ecotable, fig.align="center",out.width="95%"}
knitr::include_graphics("20190320_MAFMC_SSC_Gaichas_images/ecotable2019.png")
```
...
knitr::include_graphics("20190320_MAFMC_SSC_Gaichas_images/mgttable2019.png")
```
...
![soe-data-flow](20190320_MAFMC_SSC_Gaichas_images/soe-data-flow.png)  
...
knitr::include_graphics("20190320_MAFMC_SSC_Gaichas_images/noaa-iea.png")
```
...
knitr::include_graphics("20190320_MAFMC_SSC_Gaichas_images/nw-atlantic-circ.jpg")
```
