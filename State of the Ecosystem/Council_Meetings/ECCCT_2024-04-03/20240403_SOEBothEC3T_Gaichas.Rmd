---
title: "State of the Ecosystem<br /> Mid Atlantic and New England 2024"
subtitle: "East Coast Climate Core Team<br /> 3 April 2024"
...
p =ecodata::plot_comdat(report = "MidAtlantic", plottype = "guild") + 
...
---
## Risks to Seasonal Management: All Areas
...
```
```{r zooplankton-season, fig.alt="Dry mass of mesozooplankton captured with a 200µm ring net towed from the bottom to surface at a deep time series station  in Wilkinson Basin between 2005-2022 (Runge et al. 2023)."}
...
## Risks to Quota Setting/Rebuilding: All Areas
...
.pull-left[
![:img Net revenue, 90%](https://github.com/NOAA-EDAB/presentations/raw/master/docs/EDAB_images/Net_revenue.png)
]

.pull-right[
![:img Cost coverage, 90%](https://github.com/NOAA-EDAB/presentations/raw/master/docs/EDAB_images/Cost_Coverage.png)
]
 
```{r profit, out.width = "39%", fig.show='hold'}

knitr::include_graphics("https://github.com/NOAA-EDAB/presentations/raw/master/docs/EDAB_images/Net_revenue.png")
knitr::include_graphics("https://github.com/NOAA-EDAB/presentations/raw/master/docs/EDAB_images/Cost_Coverage.png")


```

---
## Mid-Atlantic EAFM Risk Assessment: 2024 Update with new elements
