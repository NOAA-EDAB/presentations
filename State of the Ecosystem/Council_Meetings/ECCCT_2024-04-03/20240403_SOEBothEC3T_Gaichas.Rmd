...
```{r seabird-ne-productivity, fig.alt = "Productivity of Common terns in the Gulf of Maine.",  fig.width=7.5, fig.asp=.3}
...
```{r salmon, fig.alt = "Return rate proportions and abundance of Atlantic salmon.",fig.width = 7.5,fig.asp = 0.3}
...
.pull-right[
Drivers: Low tropic levels
```{r ne-zoopanom, fig.alt="Changes in zooplankton abundance in New England for large (top left) and small (top right) copepods, Cnidarians (bottom left), and Euphausiids (bottom right), with significant increases (orange) in small copeods and Cnidarians.", fig.width=5, fig.asp=1}
