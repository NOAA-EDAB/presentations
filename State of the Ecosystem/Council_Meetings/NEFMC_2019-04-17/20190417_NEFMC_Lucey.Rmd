...
author: "Sean Lucey, Sean Hardison, and Sarah Gaichas<br /> Ecosystem Dynamics and Assessment Branch<br /> Northeast Fisheries Science Center<br /><br /><br /><br /><br />New England Fishery Management Council - April 17, 2019"
output:
...
knitr::include_graphics("EDAB_images/grayseals-noaa-nefsc-psb.jpg")
```
...
knitr::include_graphics("EDAB_images/menh-survey-strata.png")
```
]
...
knitr::include_graphics("EDAB_images/ma-survey-strata.png")
```
]
...
knitr::include_graphics("EDAB_images/NEFMC_Fish_Condition_2019.jpg")
```
...
![sumflo-stock-area](EDAB_images/sumflo-stock-area.png)
...
![ecsa_screencap](EDAB_images/ecsa_screencap.gif)
