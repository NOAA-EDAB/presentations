...
subtitle: "MAFMC<br /> 07 April 2021"
...
---
## SOE &rarr; Risk assessent example: Commercial revenue
...
##Risk elements: Fstatus, Bstatus, unchanged except <span style="background-color:yellow;">Butterfish Bstatus</span>, add element?
...
---
## Objective: Recreational opportunities ![:img no trend icon, 2%](EDAB_images/no trend.png) ![:img near average icon icon, 1%](EDAB_images/near long term average.png);  ![:img decreasing arrow icon, 2%](EDAB_images/decrease.png) ![:img below average icon icon, 2%](EDAB_images/below long term ave.png) &emsp; Risk element: <span style="background-color:red;">RecValue</span>,  unchanged; add diversity?
.pull-left[
...
---
## Objective: Fishing community status &emsp; Risk element: <span style="background-color:yellow;">Social</span>, unchanged; new community level info
...
* Risk elements: 
    - FW2Prey evaluted by species: 13 <span style="background-color:lightgreen;">low</span>, 3 <span style="background-color:yellow;">low-mod</span> risk, unchanged 
...
---
## Risks: Climate change &emsp; Risk element: EstHabitat 10 <span style="background-color:lightgreen;">low</span>, 4 <span style="background-color:red;">high</span> risk species, unchanged, new indices
...
---
## Risks: Climate change &emsp; Risk element: offshore habiat put aside, new indices
.pull-left[
...
.center[
![:img black sea bass survey distribution change over time from 2018 SOE, 70%](EDAB_images/black_sea_bass_kde.png)
]
]
...
---
background-image: url("EDAB_images/2021MAFMCreportcardSSC.png")
background-size: 600px
background-position: right

# Discussion
.pull-left[
1. Feedback on structure: keep this one, or adjust further?
...
1. Prorities for 2022 and future reports
