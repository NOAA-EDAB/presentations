...
.contrib[
Risk elements: Assess, Fstatus, most Bstatus unchanged. <span style="background-color:yellow;">Butterfish Bstatus</span> risk increased
]
]
...
---
## Objective: Recreational opportunities ![:img no trend icon, 2%](EDAB_images/no trend.png) ![:img near average icon icon, 1%](EDAB_images/near long term average.png);  ![:img decreasing arrow icon, 2%](EDAB_images/decrease.png) ![:img below average icon icon, 2%](EDAB_images/below long term ave.png) &emsp; Risk elements: <span style="background-color:red;">RecValue</span>,  unchanged; add diversity?
.pull-left[
...
---
## Objective: Stability ![:img no trend icon, 2%](EDAB_images/no trend.png) ![:img near average icon icon, 1%](EDAB_images/near long term average.png) &emsp; Risk elements: <span style="background-color:green;">FishRes1</span> and <span style="background-color:green;">FleetDiv</span>, unchanged, add recreational elements?
...
---
## Objective: Stability ![:img mixed trend icon, 2%](EDAB_images/Mixed trends.png) ![:img near average icon icon, 1%](EDAB_images/near long term average.png) &emsp; Risk elements: ecological diversity put aside, new indices
...
---
## Objective: Fishing community status &emsp; Risk elements: <span style="background-color:yellow;">Social</span>, unchanged; new community level info
...
* Risk element: TechInteract, evaluated by species and sector, unchanged
...
* Risk elements: 
    - FW2Prey evaluted by species: 13 low, 3 low-mod, unchanged 
    - TechInteract, evaluated by species and sector:
]
...
.center[
![:img summer flounder survey distribution change over time from 2018 SOE, 70%](EDAB_images/black_sea_bass_kde.png)
]
]
