...
---
## Aggregate fish trends and southern species
...
```{r rec-div3, fig.width = 5, fig.asp = 0.45, fig.cap = paste0("Recreational effort diversity and diversity of recreational catch in the ",region,".")}
...
Attempt VAST? Other data sources and suggestions?
---
