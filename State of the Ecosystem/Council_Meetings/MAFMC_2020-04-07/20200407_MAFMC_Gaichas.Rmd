...
ggplot(data = stock_status) +
  ...
  guides(color = FALSE) +
  theme_ts(base_size = 25)
```

---
## Updated feeding groups to look at aggregate biomass
...
Record high precipitation let to extreme low salinity event in spring 2019
...
```{r MAB-SST-insitu, fig.height = 8, fig.cap = "MAB seasonal sea surface time series overlaid onto 2018 seasonal spatial anomalies."}
...
---
## Changing patterns primary production
...
More production in summer months due to warmer temperatures and increased bacterial remineralization and nutrient recycling 

This increased productivity is most likely from smaller-celled species that contribute less to fish production 
