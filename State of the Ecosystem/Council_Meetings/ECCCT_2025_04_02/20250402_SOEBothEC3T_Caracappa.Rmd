...
.right[
```{r , fig.width=6, fig.asp=0.5, fig.alt="Mid-Atlantic region total climate vulnerability of commercial revenue (sum of Mid-Atlantic port revenue weighted by species climate vulnerability from Hare et al. 2016)."}
...
```{r , fig.asp=0.5, fig.alt="Fish community functional traits in the Mid Atlantic Bight based on Fall (red) and Spring (blue) survey data. Length at maturity for the full finfish community has increased in spring (orange line), but decreased in fall (purple lines)"}
...
???
---
## Mid-Atlantic Social and Climate Vulnerability &emsp; Risk element: <span style="background-color:orange;">Social</span> 
...
ecodata::plot_community_climate_vulnerability(n=10)
```
