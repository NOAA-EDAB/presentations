...
subtitle: "MAFMC <br /> 5 April 2022"
...
.pull-left[
.center[
![:img State of the Ecosystem page 1 summary table, 95%](EDAB_images/SOE-MA-final-03.23.22-no marks_Page_2.png)
]
]

.pull-right[
.center[
![:img State of the Ecosystem page 2 risk bullets, 95%](EDAB_images/SOE-MA-final-03.23.22-no marks_Page_3.png)
]
]
...
---
## 2022 State of the Ecosystem Request tracking memo
...
---
background-image: url("EDAB_images/SOE-MA-final-03.23.22-no marks_Page_2.png")
...
.pull-left-60[
Seafood production ![:img decreasing arrow icon, 4%](EDAB_images/decrease.png), status not evaluated  

Profits ![:img decreasing arrow icon, 4%](EDAB_images/decrease.png), status not evaluated 

Recreational opportunities:  Effort ![:img increasing arrow icon, 4%](EDAB_images/increase.png) ![:img above average icon icon, 4%](EDAB_images/above long term ave.png); Effort diversity ![:img decreasing arrow icon, 4%](EDAB_images/decrease.png) ![:img below average icon icon, 4%](EDAB_images/below long term ave.png)  

Stability: Fishery ![:img no trend icon, 4%](EDAB_images/no trend.png) ![:img near average icon icon, 2%](EDAB_images/near long term average.png); Ecological ![:img mixed trend icon, 4%](EDAB_images/Mixed trends.png) ![:img near average icon icon, 2%](EDAB_images/near long term average.png)  
...
Protected species: 
*  Maintain bycatch below thresholds ![:img mixed trend icon, 4%](EDAB_images/Mixed trends.png) ![:img meeting objectives icon, 4%](EDAB_images/checked.png)  
*  Recover endangered populations (NARW) ![:img decreasing arrow icon, 4%](EDAB_images/decrease.png) ![:img below average icon icon, 4%](EDAB_images/below long term ave.png)  
]
.pull-right-40[]

---
background-image: url("EDAB_images/SOE-MA-final-03.23.22-no marks_Page_3.png")
background-size: 500px
background-position: right
...
---
## Objective: Seafood production ![:img decreasing arrow icon, 2%](EDAB_images/decrease.png)  &emsp; Risk elements: <span style="background-color:red;">ComFood</span> and <span style="background-color:orange;">RecFood</span>, unchanged
...
---
## Objective: Commercial Profits ![:img decreasing arrow icon, 2%](EDAB_images/decrease.png)  &emsp; Risk element: <span style="background-color:orange;">CommRev</span>, unchanged
...
---
background-image: url("EDAB_images/SOE-MA-final-03.23.22-no marks_Page_1.png")
background-size: 600px
background-position: bottom right

# Discussion

## Improve utility to the Council

.pull-left[
1. Fishery performance at the ecosystem level:
    - Capturing factors influencing recent catch?
    - Current management appropriate? How to improve?
    - Recommended research priorities?
    - What else is important to know?
    
1. Feedback on EAFM risk assessment update, and priorities for risk assessment review?
    - New elements
    - New indicators for existing elements
...
1. Feedback on Request memo points?
    - 1 to 7 included in SOE
    - 7 to 27 in progress
    - 28 to 45 less progress
