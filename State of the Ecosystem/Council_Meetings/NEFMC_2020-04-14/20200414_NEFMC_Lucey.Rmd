...
.center[
![:img Map of 2019 chlorophyll a anomalies by season from satellite data, 15%](EDAB_images/5_FISHING.png) &nbsp; &nbsp; &nbsp; ![:img Map of 2019 chlorophyll a anomalies by season from satellite data, 15%](EDAB_images/6_INDUSTRY.png) &nbsp; &nbsp; &nbsp; ![:img Map of 2019 chlorophyll a anomalies by season from satellite data, 15%](EDAB_images/8_OTHERHUMANUSES.png)
]
...
## SOE Take Home Messages
.center[
![:img Map of 2019 chlorophyll a anomalies by season from satellite data, 15%](EDAB_images/14_OTHERFISH.png) &nbsp; &nbsp; &nbsp; ![:img Map of 2019 chlorophyll a anomalies by season from satellite data, 15%](EDAB_images/13_FORAGEFISH.png) &nbsp; &nbsp; &nbsp; ![:img Map of 2019 chlorophyll a anomalies by season from satellite data, 15%](EDAB_images/15_INVERTEBRATES.png)
]
...
## SOE Take Home Messages
.center[
![:img Map of 2019 chlorophyll a anomalies by season from satellite data, 15%](EDAB_images/1_HYDROGRAPHY.png) &nbsp; &nbsp; &nbsp; ![:img Map of 2019 chlorophyll a anomalies by season from satellite data, 15%](EDAB_images/9_PHYTOPLANKTON.png) &nbsp; &nbsp; &nbsp; ![:img Map of 2019 chlorophyll a anomalies by season from satellite data, 15%](EDAB_images/3_CLIMATE.png)
]
