...
author: "Kim Bastille, Sean Lucey, Sarah Gaichas, <br /> Geret DePiper, Kim Hyde, and Scott Large  <br /> Northeast Fisheries Science Center <br /> Integrated Statistics"
output:
...
.pull-right[
```{r bot-temp, fig.width=7, fig.asp = 0.45, fig.cap="Annual bottom temperature anomalies on the Northeast Shelf."}
ecodata::bottom_temp %>%
...
```{r cold_pool, eval = T, echo = F, fig.width=7, fig.asp = 0.45, fig.cap="Cold pool index - mean bottom temperature anomaly for Sept-Oct in the MAB." }
ecodata::cold_pool %>% 
    dplyr::mutate(hline = mean(Value, na.rm = T)) %>% 
  ggplot2::ggplot() + 
 #Highlight last ten years
