...
.pull-left[
```{r wind-hab, fig.retina=3, eval = T, echo = F, fig.height = 6,  message=FALSE, results=FALSE}
...
**Research Spotlight**
<br>
![:img Condition factor for fish species in the GOM,  250%](EDAB_images/SOEconditionfactorlinks_color.png)
]
...
.pull-right[
```{r total-rev, fig.width = 5, fig.asp = 0.45}
#Filtering and aggregation step
rev_agg <- ecodata::comdat %>% 
  filter(str_detect(Var, "Revenue"),
         !str_detect(Var, "prop|Other|NEFMC"), #Remove proportions, "Other" category species, NEFMC managed species in MAB
...
```{r bennet, fig.width = 5, fig.asp = 0.57}
