...
.pull-right[
<br>
```{r list, echo=FALSE, message=FALSE, warnings=FALSE, results='asis'}
tabl <- "
| Acronym       | Definition                                                          |  
|:-------------------|:--------------------------------------------------------------------|
...
.pull-left[
![Map of existing and proposed wind lease areas](EDAB_images/wind_map.png)
]
...
---
## New information on forage fish energy density (ED)
