---
title: "State of the Ecosystem: <br /> 2021 Overview"
subtitle: "OneNOAA Seminar<br /> 04 May 2021"
author: "Kimberly Bastille <br /> <br /> Sarah Gaichas, Sean Lucey, Kimberly Hyde,<br /> Geret DePiper and Scott Large"
output:
...
Mid-Atlantic - Commercial and Recreational Landings
.pull-left[
...
New England - Revenue and Bennet Index of Price and Volume
...
## Objective: Recreation ![:img no trend icon, 2%](EDAB_images/no trend.png) ![:img near average icon icon, 1%](EDAB_images/near long term average.png);  ![:img decreasing arrow icon, 2%](EDAB_images/decrease.png) ![:img below average icon icon, 2%](EDAB_images/below long term ave.png)
...
* May be vulnerable to environmental justice issues.
...
```{r, code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/human_dimensions_MAB.Rmd-commercial-engagement.R"), fig.height=8}
```
...
.pull-right[
Indicators: bottom temperatures and cold pool
```{r , code=readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/LTL_MAB.Rmd-bottom-temp.R"), fig.width=6}
```
