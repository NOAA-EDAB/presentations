...
.pull-left[
* Climate in GOM and GB are linked to large-scale cycles like the **North Atlantic Oscillation (NAO)** and **Atlantic Multidecadal Oscillation (AMO)**
...
* NAO: A [teleconnection](https://en.wikipedia.org/wiki/Teleconnection) of inverted atmospheric pressures over Greenland and the central North Atlantic<sup>1</sup>
  ...
  * NA affects influence of Gulf Stream waters in New England
]
