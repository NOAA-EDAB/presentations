---
title: "State of the Ecosystem 2025 <br /> Performance Relative to Objectives"
subtitle: "SOE January Synthesis Meeting<br /> 22 January 2025"
output:
...
a <- ecodata::plot_comdat(report = "NewEngland", varName = "landings", n=10)
...
a <- ecodata::plot_aggregate_biomass(report = "NewEngland", EPU = "GB", n=10) + ggplot2::ggtitle("Georges Bank")
b <- ecodata::plot_aggregate_biomass(report = "NewEngland", EPU = "GOM", n=10) + ggplot2::ggtitle("Gulf of Maine")
...
ecodata::plot_bennet(report = "NewEngland", EPU = "GB")
ecodata::plot_bennet(report = "NewEngland", EPU = "GOM")
```
]
...
ecodata::plot_commercial_div(report = "NewEngland", varName = "Fleet count", n=10)
```
.contrib[
...
ecodata::plot_ichthyo_diversity(report = "NewEngland", n=10)
```
...
commsocvul <- read.csv(here::here("data-raw/fishdata_2022_CSVI_final (1).csv"))

# logic: category gets the max indicator rank, I think this is how EJ works

commsocvulrank <- commsocvul |>
...
MA_com_plot <- commsocvulrank |>
  ...
  ggrepel::geom_label_repel(aes(label = ifelse(ComEng>3.1,as.character(GEO_NAME),ifelse(ComRel>3.8,as.character(GEO_NAME),''))),
                   size=2,
                   box.padding   = 0.4, 
                   point.padding = 0,
...
Bobby2 <-  magick::image_read("https://github.com/NOAA-EDAB/ecodata/raw/dev/data-raw/workshop/images/MA_rec-BobbyMurphy_2025.png")
...
Bobby3 <-  magick::image_read("https://github.com/NOAA-EDAB/ecodata/raw/dev/data-raw/workshop/images/NE_com-BobbyMurphy_2025.png")
...
Bobby4 <-  magick::image_read("https://github.com/NOAA-EDAB/ecodata/raw/dev/data-raw/workshop/images/NE_rec-BobbyMurphy_2025.png")
