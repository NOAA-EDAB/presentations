...
```
![:img 150%](https://github.com/NOAA-EDAB/presentations/raw/master/docs/EDAB_images//ches-bay-sst-1.png)-->
]
...
.pull-left-30[
```{r , code=readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/macrofauna_NE.Rmd-seabird-ne-map.R")}
```

Common tern productivity decline reflecting prey, other drivers?
]
...
.pull-left-30[
```{r , code=readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/macrofauna_MAB.Rmd-forage-index.R")}
```
]

.pull-right-70[
```{r , code=readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/macrofauna_NE.Rmd-forage-index.R")}
```
]

Is the forage base changing over time?

VAST model using 22 predators to sample 20 forage fish groups, includes more unmanaged forage (anchovies, sandlance) than direct trawl data. 
...
```{r , code=readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/macrofauna_MAB.Rmd-protectedspp-dist-shifts.R"), fig.width=5, fig.asp=0.8}
```
]
]
...
## Risks: Offshore Wind Development New Englad
