...
author: "Sarah Gaichas, Kimberly Bastille, Geret DePiper, Kimberly Hyde, Scott Large, Sean Lucey<br /> Northeast Fisheries Science Center<br /> and all SOE contributors"
output:
...
```{r , code=readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/LTL_NE.Rmd-bottom-temp-insituglorys.R"), fig.width=6}
```
]
...
## Risks: Climate change and Mid Atlantic estuarine habitat &emsp; Risk element: EstHabitat 11 <span style="background-color:lightgreen;">low</span>, 4 <span style="background-color:red;">high</span> risk species
...
.pull-right[
```{r, eval=FALSE}
#, code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/human_dimensions_MAB.Rmd-wea-port-rev.R"), fig.asp=1.1
```
]

---
background-image: url("https://github.com/NOAA-EDAB/presentations/raw/master/docs/EDAB_images//offshore_wind_timeline.png")
background-size: 500px
background-position: right
