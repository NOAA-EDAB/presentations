...
---
## State of the Ecosystem report structure: graphical summary (showing 2023)
.pull-left[
.center[
![:img State of the Ecosystem page 1 summary table, 95%](https://github.com/NOAA-EDAB/presentations/raw/master/docs/EDAB_images//SOE-MA-draft-03.16.23_Page_2.png)
]
]

.pull-right[
.center[
![:img State of the Ecosystem page 2 risk bullets, 95%](https://github.com/NOAA-EDAB/presentations/raw/master/docs/EDAB_images//SOE-MA-draft-03.16.23_Page_3.png)
]
]
...
* Risks to meeting fishery management objectives
    ...
    - *Why* this is important to managers: integrates synthesis themes
        ...
        - Ecosystem reorganization
* Risk categories
    <p style="color:#FF6A6A;">- Climate: warming, ocean currents, acidification
...
ecodata::plot_stock_status(report = "MidAtlantic")
...
```
I never put NAFO back in for 2019-2022. ARGH Andy working on it
...
ecodata::plot_stock_status(report = "NewEngland")
```
.contrib[
...
ecodata::plot_bennet(report="MidAtlantic")
```
]
...
```{r , fig.width = 7.5, fig.asp = 0.45, results = 'hide'}
