...
1. Preface: What is a "forage fish"?
...
1. Alaska pollock: ecological research with a food web model  
...
---
## 3. How does ecosystem structure affect dynamics? 
...
---
## 4.  Are any Atlantic herring harvest control rules good for both fisheries and predators?
```{r intro}
...
---
## 5. Epilogue: integrated ecosystem assessment
...
Fisheries stock assessment and ecosystem modeling continue to develop—can we keep pace with climate? 
...
* [NOAA State of the Ecosystem summary webpage](https://www.fisheries.noaa.gov/new-england-mid-atlantic/ecosystems/state-ecosystem-reports-northeast-us-shelf)
...
---
## Appendix: Fishery management in the US
