...
## In progress
*  Sensitivity to fishing scenarios in prep for strategic management applications
...
---
# Rpath: new regional models

Brandon Beltz: MAB model

Sarah Weisberg: GOM model
...
---
## WGSAM 2022: constructed model (framework) review
...
# Multispecies models: how do we know they are right?
