...
Need: assessment model data inputs and life history parameters (based on actual Sardine assessment)
...
---
## Specify uncertainty in assessment "data": Your input requested!
