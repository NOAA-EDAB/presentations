...
* Interest centers on the decision making process. 
  *   Incorporating as many species specific decisions while still enabling an automated, reproducible and transparent process for wrangling catch data
...
* Time scales for length-weight relationships
...
* QA/QC code to remove anomalous values
