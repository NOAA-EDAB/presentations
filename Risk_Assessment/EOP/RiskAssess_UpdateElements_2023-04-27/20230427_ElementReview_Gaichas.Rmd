...
elements<-data.frame(
  Category = c("Ecological","Ecological","Ecological","Ecological","Ecological","Ecological","Ecosystem","Ecological","Ecological","Ecological","Put Aside","Economic","Economic","Economic","Economic","Social","Social","Food Production","Food Production","Management","Management","Management","Management","Management","Management","Put Aside","Put Aside","Put Aside","Put Aside","Put Aside","Put Aside","Put Aside","Put Aside"),
...
elements2<-elements %>%
  dplyr::filter(Category %in% c("Ecosystem","Economic", "Social", "Food Production")) %>%
...
kable(elements2, "html") %>%
  ...
  group_rows("Ecosystem", 1,1) %>%
  group_rows("Economic", 2,5) %>%
  group_rows("Social", 6,7) %>%
  group_rows("Food Production", 8,9)
...
---
## Reconsider risk elements put aside in 2017?
