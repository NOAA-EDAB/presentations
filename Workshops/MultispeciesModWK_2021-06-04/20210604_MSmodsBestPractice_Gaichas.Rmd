...
Also that you need to be part of a management process to improve likelihood that the model will address a management problem of interest, and ultimately to have the model used, see also `r Cite(myBib,"townsend_progress_2019")`.
]
.pull-right-40[
...
## MICE for MSE: Linked single species models `r Cite(myBib, "deroba_dream_2018")`  
