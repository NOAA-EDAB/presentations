...
---
## Appendix: Multispecies catch at age estimation model: *seeking catchy name* [FIT: MSCAA](https://nmfs-ecosystem-tools.github.io/MSCAA/)
...
---
## Appendix: Multispecies catch at length simulation model: [Hydra](https://github.com/NOAA-EDAB/hydra_sim)
...
---
## Appendix: Multispecies production simulation: [Kraken](https://github.com/NOAA-EDAB/Kraken) and estimation [FIT: MSSPM](https://nmfs-ecosystem-tools.github.io/MSSPM/)
...
## Appendix: Food web: [Rpath](https://github.com/NOAA-EDAB/Rpath) in collaboration with AFSC
.pull-left[ 
Species interactions:
