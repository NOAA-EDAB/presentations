...
Changing natural mortality resulting from predation cannot be modeled in single species assesments

For example, ICES WGSAM is asked to provide M-at-age time series for North Sea and Baltic herring, cod, whiting, haddock, sprat, sandeel, and possibly other species. Spatial scale is at the stock level and temporal resolution is annual, starting at a stock-specific year and going to 2018. 
