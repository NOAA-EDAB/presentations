...
---
## Designing skill assessment

.pull-left[
![](EDAB_images/PoseidonDesign.png)
]
.pull-right[
![](EDAB_images/expdesignfig.png)
]
---
...
![](EDAB_images/atlantisomlanding-top.png)
]
.pull-right[
![](EDAB_images/atlantisomlanding-getstarted.png)
]
...
![](EDAB_images/NOBAsurvey-perfect.png)
]
.pull-right[
Survey with catchability and selectivity
![](EDAB_images/atlantisomNOBAsurvey-qsel.png)
]
...
.pull-left[
![](EDAB_images/NOBAcapelinlengths.png)
![](EDAB_images/NOBAhalibutlengths.png)
]
.pull-right[
![](EDAB_images/NOBAcapelinage.png)
![](EDAB_images/NOBAhalibutage.png)
]
---
## `atlantisom` outputs, diet compositions, [link](https://sgaichas.github.io/poseidon-dev/SurveyDietCompTest.html)

.pull-left[
![](EDAB_images/NOBAcoddiettrue.png)
]
.pull-right[
![](EDAB_images/NOBAcodspringfallsurvdiet.png)
]
...
.center[
![:img xkcd_ensemble_model_2x, 75%](EDAB_images/xkcd_ensemble_model_2x.png)
]
---
