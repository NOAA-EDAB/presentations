...
---
# Today: species interactions in different models
...
---
## Multispecies catch at age estimation model: *seeking catchy name* 
...
[FIT: MSCAA](https://nmfs-ecosystem-tools.github.io/MSCAA/)
...
Suitability, $\rho$, of prey species $m$ size $n$ for a given predator species $i$ size $j$ a function of size preference, $\vartheta$, and vulnerability, $\lambda$ {0,1}. 
...
We specify 'preferred' predator-prey weight ratio (log scale) $\Psi_j$ and variance in predator size preference $\sigma_j$ to compare with the actual predator-prey weight ratio $(w_n / w_j)$. 
...
Species interactions: 
- Predation: Top down 
- Prey dependence: sort of
- Competition: affects?

Equation


[Kraken](https://github.com/NOAA-EDAB/Kraken) 
...
Species interactions:
- Full predator-prey feedback: Predator consumption leads to prey mortality and predator growth
- Static and dynamic model components; dynamic model with MSE capability
.pull-left[
Static model: 
