...
subtitle: "ICES PICES Small Pelagic Fish Symposium <br /> Session 5 <br /> 10 November 2022"
...
Two linear predictors for an index: 1. encounter rate,  and 2. amount 
...
knitr::include_graphics("https://fishinginmiami.com/wp-content/uploads/2018/07/Miami-sea-trout-fishing.png")
# credit: https://fishinginmiami.com/spotted-seatrout/
...
.pull-left[
```{r WHAMfall, fig.cap="Time series of VAST estimated fall forage indices for input into WHAM, 1985-2021", fig.asp=0.8}
...
```{r SOEforage, fig.cap="Time series of VAST estimated fall forage indices for the 2023 State of the Ecosystem report", fig.asp=0.8}
...
---
## P.S., Did it help the assessment? Preliminary results... assessment review in December 2022

.pull-left[
A new bluefish stock assessment was implemented using the Woods Hole Assessment Model (WHAM) `r Cite(myBib,"stock_woods_2021")`.

Forage fish indices were explored as covariates on catchability for the NEFSC fishery independent bottom trawl surveys, but either did not improve the assessment, or the exploratory models did not converge.
