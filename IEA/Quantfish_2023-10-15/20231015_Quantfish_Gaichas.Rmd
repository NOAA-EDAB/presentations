...
1. Addressing uncertainty in the stock assessment for a key predator species, bluefish (*Pomatomus saltatrix*) 
...
Expected mass of forage in a predator stomach is the product of the encounter probability of forage in the stomach times weight in the stomach. 

Poisson link delta model
Probability of encounter Poisson: $p(i) = 1 - exp[-n(i)]$

Index based on area weighting
...
.pull-left[
```{r, fig.asp=1}
dietoverlap <- read_csv("https://raw.githubusercontent.com/NOAA-EDAB/forageindex/main/fhdat/tgmat.2022-02-15.csv")
...
.footnote[
All piscivore diet collection stations, fall NEFSC and NEAMAP surveys &rarr;
]
...
```{r sppprop, fig.cap="Comparison of raw proportional species composition from all predator stomachs combined (source = stomach, red) to the raw proportional species composition from bottom trawl survey sampling (source = survey, black) in the model domain forall regions and seasons from 1985-2021.", fig.asp=0.6}
...
.center[
```{r MAforagebio, code=readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/macrofauna_MAB.Rmd-forage-index.R"), fig.asp=.6, out.width="50%"}
...
Benthic index for food web modeling
