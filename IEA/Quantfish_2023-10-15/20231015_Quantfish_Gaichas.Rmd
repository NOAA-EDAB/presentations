...
1. Alternative ways to build a forage index: data sources, design vs. model based methods 

1. A promising method: Vector Autoregressive Spatio-Temporal (VAST) modeling
