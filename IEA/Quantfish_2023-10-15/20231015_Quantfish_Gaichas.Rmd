...
.pull-left[
Observations correlated in space and in space over time due to unmeasured processes are modeled as Gaussian Random Fields with mulstvariate normal effects:

$\omega_1$ ~ MVN(0, **R**~1~); $\omega_2$ ~ MVN(0, **R**~2~)   
$\varepsilon_1$(,t) ~ MVN(0, **R**~1~); $\varepsilon_2$(,t) ~ MVN(0, **R**~2~)  
  
Mat\'ern correlation function between locations s~a~ and s~b~
...
.pull-right[
How? Specify n "knots" to group observation locations, assume constant variation within a timestep at a knot
