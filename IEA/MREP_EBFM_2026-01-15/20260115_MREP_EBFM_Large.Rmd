...
subtitle: "Marine Resource Education Program <br /> Science Workshop, January 2026"
author: "Scott Large<br /> NOAA Northeast Fisheries Science Center"
output:
...
library(widgetframe)
library(patchwork)
# remotes::install_github("SWotherspoon/QPress", build_vignettes = FALSE)
...
.pull-right[
  .center[
    ![relating environment marine habitat and the marine community to human activities social systems and objectives](https://github.com/NOAA-EDAB/presentations/raw/master/docs/EDAB_images/nes-components-abstracted.png)
  ]
]
...
.pull-right[
  .center[
    ![](https://github.com/NOAA-EDAB/presentations/raw/master/docs/EDAB_images/EBFMprinciples.png)
  ]
]
---
## Today's outline
...
edges <- QPress::model.dia(file.path(data.dir, "Summer_Flounder_July22_2019.dia"))

source(here::here("R/interactive_chord_sfconsmod.R"))
