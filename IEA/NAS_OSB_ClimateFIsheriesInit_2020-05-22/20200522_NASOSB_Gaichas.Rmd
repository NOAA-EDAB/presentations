...
.pull-left[
![:img CSIRO Australia management strategy evaluation description](EDAB_images/MSECSIRO.png)
]

.pull-right[
![:img Poseidon project operating model setup with climate projection](EDAB_images/projectionOMsetup.png)
]
