---
title: "What is Ecosystem Based Fishery Management?"
subtitle: "Marine Resource Education Program <br /> Science Workshop, February 2020"
author: "Sarah Gaichas, Northeast Fisheries Science Center <br />with key slides from <br />Jason Link, NOAA Senior Scientist for Ecosystem Management"
output:
  xaringan::moon_reader:
    css: ["default", "libs/EDAB_theme3-0_508.css"]
    lib_dir: libs
    nature:
...
library(rpart)
library(colorRamps)
remotes::install_github("noaa-edab/ecodata@0.1.0") #needed for older SOE code
library(ecodata)
...
.footnote[
https://www.fisheries.noaa.gov/national/ecosystems/implementing-ecosystem-based-fisheries-management#understanding-the-levels-of-ecosystem-based-management
]
---
...
---
# More concrete EBFM--two examples
...
- New England Atlantic herring: fishery management strategy evaluation  
...
- Mid-Atlantic EAFM conceptual modeling (towards strategy evaluation)
