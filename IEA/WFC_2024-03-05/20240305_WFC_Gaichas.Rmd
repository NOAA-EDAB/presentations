...
author: Sarah Gaichas$^1$, Kimberly Bastille$^1$, Andy Beet$^1$, Brandon Beltz$^1$, Joseph Caracappa$^1$, Geret DePiper$^1$, Kimberly Hyde$^2$, <br />Scott Large$^1$, Sean Lucey$^{1,3}$, Brandon Muffley$^4$, Laurel Smith$^1$, Abigail Tyrell$^1$
...
---
## Ecosystem reporting in the Northeast US: Focus on the fishery management audience
...
.pull-right[
*2024 Report*
![:img scallop stress bottom temp, 85%](https://github.com/NOAA-EDAB/ecodata/raw/dev/workshop/images/bottom_temp_threshold_17_19_Elephant_Trunk.png)
]
