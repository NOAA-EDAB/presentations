...
.pull-left-70[
.center[
![:img Bluefish illustration NOAA Fisheries, 50%](https://media.fisheries.noaa.gov/styles/original/s3/2022-08/640x427-Bluefish-NOAAFisheries.png)
]
...
```{r, crop=TRUE, fig.show='hold', out.width="33%"}
...
.center[
New spatial "forage index" of 20 prey groups from stomach contents of 22 predators `r Cite(myBib, "gaichas_assessing_2023")`
]
...
The bluefish assessment was implemented using the Woods Hole Assessment Model (WHAM) `r Cite(myBib,"stock_woods_2021")` with the forage index as a catchability covariate.
...
---
## New for 2024: Align climate risks with management decisions

.pull-left[
* Distribution shifts and risks to allocation, bycatch management
...
* Main drivers: temperature and ocean circulation
* Unlikely to revert to 1980s conditions in the short term
* Reconsider allocations, spatial bycatch management
...
* Timing shifts and risks to seasonal management
* Productivity shifts and risks to quota setting, reference points
...
---
.pull-left[
## Productivity risks: Are we observing multispecies shifts?
...
Implications: 
Species in the MAB had mixed condition in 2023. Fish productivity based on surveys and assessments has been below average. 
...
## How would we use these in management?
.pull-left-60[

MAFMC SSC discussion:
