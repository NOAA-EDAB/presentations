...
.center[
![:img Mid-Atlantic workflow, 80%](EDAB_images/MAapproach.png)
]
...
.center[
![:img Mid-Atlantic EAFM framework, 70%](EDAB_images/Framework.png)
]
...
.right[
![:img example conceptual model, 78%](EDAB_images/fmars-03-00105-g011.jpg)
]
...
.center[
![:img scaled down conceptual model, 60%](EDAB_images/nes-components-abstracted.png)
]
???
