...
---
## Risk assessment results: species and sector 
.pull-left-70[
...
risk.sppsector %>%
  mutate_at(vars(-Species), function(x){ 
    cell_spec(x, format="html", color = factor(x, c("na", "lowest", "lowmod", "modhigh", "highest"),c("black", "white", "black", "white", "white")), align = "c", background =factor(x, c("na", "lowest", "lowmod", "modhigh", "highest"),c("white", "green", "yellow", "orange", "red")), background_as_tile=F)}) %>%
  kable(format = "html", escape = F, booktabs = T, linesep = "") %>%
...
.pull-right-30[
.footnote[
Gaichas, S. K., DePiper, G. S., Seagraves, R. J., Muffley, B. W., Sabo, M., Colburn, L. L., and Loftus, A. L. 2018. Implementing Ecosystem Approaches to Fishery Management: Risk Assessment in the US Mid-Atlantic. Frontiers in Marine Science, 5.
]
]
???
...
risk.eco %>%
  mutate_at(vars(-System), function(x){ 
    cell_spec(x, format="html", color = factor(x, c("na", "lowest", "lowmod", "modhigh", "highest"),c("black", "white", "black", "white", "white")), align = "c", background =factor(x, c("na", "lowest", "lowmod", "modhigh", "highest"),c("white", "green", "yellow", "orange", "red")), background_as_tile=F)}) %>%
  kable(format = "html", escape = F, booktabs = T, linesep = "") %>%
  kable_styling(c("striped", "condensed"), font_size =  9)
