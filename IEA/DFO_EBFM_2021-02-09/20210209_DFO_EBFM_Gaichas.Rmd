...
.pull-right-70[
![:img MAFMC fishery management plans and species, 95%](EDAB_images/MAFMPs2.png)
]
...
.center[
![:img Mid-Atlantic EAFM development with full details in speaker notes, 70%](EDAB_images/MAapproach.png)
]
...
.center[
![:img Mid-Atlantic EAFM framework with full details in speaker notes, 50%](EDAB_images/Framework.png)
]
...
.right[
![:img example conceptual model with details in speaker notes, 60%](EDAB_images/fmars-03-00105-g011.jpg)
]
...
.pull-right[
```{r total-rev, code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/human_dimensions_MAB.Rmd-comdat-comm-revenue.R"), fig.width = 5, fig.asp = 0.45, fig.cap = "Total revenue for the region (black) and revenue from MAFMC managed species (red)."}

```

```{r bennet, code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/human_dimensions_MAB.Rmd-bennet.R"), fig.cap = paste0("Revenue change from the 2015 base year in 2015 dollars (black), Price (PI), and Volume Indicators (VI) for commercial landings in the ",region,"."), fig.width = 5, fig.asp = 0.57}
